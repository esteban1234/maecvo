...
<div class="bannern">
    <article class="fondo">
        ...
        <article class="mensaje">Fomentamos los valores en la sociedad y resolvemos problemas importantes.</article>
...
<p class="textonn">Somos una empresa pionera en consultoría y capacitación empresarial y académica en el mercado, siempre a la vanguardia con servicios profesionales innovadores. Contamos con profesionales que están comprometidas con la entrega de calidad en servicios de auditoría, impuestos y consultoría.</p>


<section class="seccion">
  <article class="contenmvo">
      ...
      <h1 class="titval">Nuestros valores</h1>
        <div class="row">
          ...
          <div class="col-md-3 etica">
            ...
            <h2 class="text-center">Profesionalismo</h2>
            <p class="text-center">Buscar la satisfacción de nuestros clientes a través de la excelencia.</p>
          </div>
        </div>
      </div>
      <article class="boton">
